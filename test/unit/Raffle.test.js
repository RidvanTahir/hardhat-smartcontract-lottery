    ...
    : describe("Raffle Unit Tests", async function () {
          ...
          describe("enterRaffle", function () {
              ...
              it("doesn't allow enterance when raffle is calculating", async function () {
                  ...
                  // pretend to be a Chain Link Keeper
          ...
          describe("checkUpkeep", function () {
              it("returns false if people haven't entered yet", async function () {
                  await network.provider.send("evm_increaseTime", [interval.toNumber() + 1])
                  await network.provider.send("evm_mine", [])
          ...
          describe("fulfillRandomWords", function () {
              ...
              it("picks a winner, resets the lottery, and sends the money", async function () {
                  const startingEntrants = 3
                  const startingAccountIndex = 3
                  const accounts = await ethers.getSigners()
                  for (
                      let i = startingAccountIndex;
                      i < startingAccountIndex + startingAccountIndex;
                      i++
                  ) {
                  ...
                  // fulfillRamdomWords (mock being chainlink vrf)
                  // we will have to wait fulfillRandomWords to be called
